<?php
$list = $contents->getContentsList("ct.id_category = 3", 6);
?>
<section>
    <div class="section grey-bg top-separator">
        <div class="container">
            <h3 class="text dark featured-title">Customer Experience</h3>
                ...
                <div class="row no-left">
                    <?php if (count($list) > 0) { ?>
                        ...
                        <div class="full-continue-btn-container">
                            <button>Mais sobre Customer Experience <i class="fa fa-arrow-right"></i></button>
                        </div>
                    <?php } else { ?>
