...
<?php require_once(DIRNAME . "../components/series/header-featured.php"); ?>
<?php require_once(DIRNAME . "../components/series/featured.php"); ?>
<?php require_once(DIRNAME . "../components/series/promote-serie.php"); ?>
