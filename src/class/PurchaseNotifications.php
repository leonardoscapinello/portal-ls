...
class PurchaseNotifications
{
    ...
    public function newAccount($username, $name, $password)
    {
        try {
            ...
            $email->paragraph("Perfil do Facebook: <a href=\"https://www.facebook.com/oleonardoscapinello\" target=\"_blank\">https://www.facebook.com/oleonardoscapinello</a><br>Perfil do Instagram: <a href=\"https://www.instagram.com/oleonardoscapinello\" target=\"_blank\">@leonardoscp_</a>");
            ...
            $email->paragraph("Você pode enviar sua dúvida em nossas centrais de ajuda dentro do próprio portal, no grupo do Telegram ou enviar um e-mail para o suporte em: suporte@lsgo.me");
            return $email->save();
